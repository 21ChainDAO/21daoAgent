...
export default function Docs() {
  return (
    <StaticPage title="HOW IT WORKS" kicker="// DOCS.SYS">
      ...
      <ul>
        <li><strong>PAPER ARCADE</strong> — entry: 1 SOL • prize pool: $10,000 + 30,000,000 dBET.</li>
        <li><strong>REAL MONEY ARENA</strong> — entry: 10 SOL • prize pool: $100,000 + 70,000,000 dBET.</li>
      </ul>
      ...
      <ul>
        <li>50% Locked</li>
        <li>10% Rewards &amp; giveaways</li>
        <li>7% Real-arena prize pool</li>
        <li>3% Paper-arena prize pool</li>
        <li>30% Public fair launch</li>
      </ul>
      <p>Contract address: <code>TBA</code> — published in the token section on the homepage at launch.</p>
